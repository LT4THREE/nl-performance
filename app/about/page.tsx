...
const ministryCoverage: {
  ...
  { ministry: "Onderwijs, Cultuur & Wetenschap (OCW)", domain: "Education", primarySource: "CBS, DUO, OECD PISA", status: "live" },
  { ministry: "Volksgezondheid, Welzijn & Sport (VWS)", domain: "Health / social outcomes", primarySource: "CBS, RIVM, NZa", status: "live" },
  { ministry: "Justitie & Veiligheid (JenV)", domain: "Social / security", primarySource: "CBS, Politie, WODC", status: "next" },
